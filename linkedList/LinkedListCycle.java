...
public class LinkedListCycle {
	...
	public static void main(String[] args) {
		LinkedListCycle myObj = new LinkedListCycle();
		
		// Example 1: List with cycle (3 -> 2 -> 0 -> -4 -> 2)
		...
		System.out.println("List 1 (Cycle): " + myObj.hasCycle(head1) + " (Expected: true)");
		...
		System.out.println("List 2 (No Cycle): " + myObj.hasCycle(head2) + " (Expected: false)");
	}
}